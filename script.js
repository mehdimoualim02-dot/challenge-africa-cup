/**
 * Cup of Africa Pronostics - Phase 1 Ranking Renderer (works with password gate)
...
(function () {
  ...
  // Boot function called by auth.js after unlock
  function boot() {
    const mount = document.getElementById('ranking');
    renderRanking(mount);
  }

  // Expose an API for the gate and future updates
